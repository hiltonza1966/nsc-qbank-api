# QBank Complete Schema & Seed Data Guide v4.0
**Date:** 14 June 2026 21:35
**Updated:** Import route column fixes verified during end-to-end wizard testing
...
## 8. ITEM MASTER TABLE — CORRECTED (Import Route Fixes Applied 2026-06-14)
...
**CRITICAL CORRECTIONS (Verified 2026-06-14):**
| Column | Wrong (Old) | Correct (Actual) | Status |
|--------|-------------|-------------------|--------|
| difficulty_id | difficulty_level_id | difficulty_id | ✅ Fixed in import route |
| marks | auto_corrected_marks | marks | ✅ Fixed in import route |
| marks_allocated | Missing | marks_allocated (NOT NULL) | ✅ Added to import route |

**Import Route INSERT (Verified Working):**
```sql
...
## IMPORT ROUTE COLUMN MAP (Verified 2026-06-14)
