...
router.post('/', auditLog, async (req, res) => {
  ...
  const {
    ...
    caps_topic_id = null, caps_subtopic_id = null, caps_reference = null,
    ...
    await db.execute(
      `INSERT INTO item_master
       (item_id, subject_official_code, subject_alpha_code, paper_no, subject_id, paper_id,
        ...
        language_id, item_type_id, marking_scheme_id, caps_topic_id, caps_subtopic_id, caps_reference,
      ...
      [item_id, subject_official_code, subject_alpha_code || subject_official_code, paper_no, subject_id, paper_id,
       ...
       caps_topic_id, caps_subtopic_id, caps_reference, created_by,
...
router.put('/:id', auditLog, async (req, res) => {
  ...
  try {
    ...
    const {
      ...
      cognitive_level_id, difficulty_id, caps_topic_id, caps_subtopic_id, caps_reference,
    ...
    await conn.execute(
      `UPDATE item_master SET
        ...
        caps_topic_id = COALESCE(?, caps_topic_id),
