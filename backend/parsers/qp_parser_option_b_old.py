#!/usr/bin/env python3
"""QP Parser Option B - Hybrid X.Y + X.Y.Z format (PyMuPDF version).
Handles: Physical Sciences, Mathematics, Technical Sciences, Technical Mathematics, Accounting.
...
def extract_qp_items_option_b(pdf_path):
    """Extract question items from QP PDF using PyMuPDF."""
