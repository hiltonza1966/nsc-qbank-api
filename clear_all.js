...
async function clear() {
  ...
  const tables = ['parse_results', 'parse_memos', 'parse_sessions', 'item_master', 'item_memos', 'item_attachments'];
  for (const t of tables) {
    try { await c.execute(`DELETE FROM ${t}`); console.log('Cleared:', t); } catch(e) { console.log('Error:', t, e.message); }
  }
