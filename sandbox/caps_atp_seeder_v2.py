#!/usr/bin/env python3
"""
QBank CAPS Database Seeder - FIXED v2
Uses correct column name: subject_name (not name)
"""
...
def generate_seed_sql():
    ...
    sql_lines.append("-- FIXED v2: correct column name subject_name")
    sql_lines.append("-- ============================================")
    sql_lines.append("")
    ...
    for subject, topics in sorted(subject_topics.items()):
        ...
        for topic_name, topic_data in sorted(topics.items()):
            ...
            # FIXED: Use correct column name 'subject_name' not 'name'
            sql_lines.append(f"")
    ...
    sql_file = "caps_atp_seed_v2.sql"
    with open(sql_file, 'w', encoding='utf-8') as f:
        f.write("\n".join(sql_lines))

    print(f"\n✓ Fixed SQL v2 saved to: {sql_file}")
