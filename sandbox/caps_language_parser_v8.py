#!/usr/bin/env python3
"""
QBank CAPS Language Parser v8 - Matches actual database schema
"""
...
LANGUAGE_CONFIG = {
    'ENGLISH': {
        'hl': {'official_code': '11351001', 'alpha': 'ENHL', 'prefix': 'ENGH', 'strand': 'English Home Language', 'family': 'English'},
        'fal': {'official_code': '11352001', 'alpha': 'ENFAL', 'prefix': 'ENGF', 'strand': 'English First Additional Language', 'family': 'English'},
        'sal': {'official_code': '11353001', 'alpha': 'ENSAL', 'prefix': 'ENGS', 'strand': 'English Second Additional Language', 'family': 'English'},
    },
    'AFRIKAANS': {
        'hl': {'official_code': '11351002', 'alpha': 'AFHL', 'prefix': 'AFRH', 'strand': 'Afrikaans Home Language', 'family': 'Afrikaans'},
        'fal': {'official_code': '11352002', 'alpha': 'AFFAL', 'prefix': 'AFRF', 'strand': 'Afrikaans First Additional Language', 'family': 'Afrikaans'},
        'sal': {'official_code': '11353002', 'alpha': 'AFSAL', 'prefix': 'AFRS', 'strand': 'Afrikaans Second Additional Language', 'family': 'Afrikaans'},
    },
    'ISIZULU': {
        'hl': {'official_code': '11351003', 'alpha': 'ZUHL', 'prefix': 'ZULH', 'strand': 'isiZulu Home Language', 'family': 'isiZulu'},
        'fal': {'official_code': '11352003', 'alpha': 'ZUFAL', 'prefix': 'ZULF', 'strand': 'isiZulu First Additional Language', 'family': 'isiZulu'},
        'sal': {'official_code': '11353003', 'alpha': 'ZUSAL', 'prefix': 'ZULS', 'strand': 'isiZulu Second Additional Language', 'family': 'isiZulu'},
    },
    'ISIXHOSA': {
        'hl': {'official_code': '11351004', 'alpha': 'XHHL', 'prefix': 'XHOH', 'strand': 'isiXhosa Home Language', 'family': 'isiXhosa'},
        'fal': {'official_code': '11352004', 'alpha': 'XHFAL', 'prefix': 'XHOF', 'strand': 'isiXhosa First Additional Language', 'family': 'isiXhosa'},
        'sal': {'official_code': '11353004', 'alpha': 'XHSAL', 'prefix': 'XHOS', 'strand': 'isiXhosa Second Additional Language', 'family': 'isiXhosa'},
    },
    'ISINDEBELE': {
        'hl': {'official_code': '11351005', 'alpha': 'NBHL', 'prefix': 'NDEH', 'strand': 'isiNdebele Home Language', 'family': 'isiNdebele'},
        'fal': {'official_code': '11352005', 'alpha': 'NBFAL', 'prefix': 'NDEF', 'strand': 'isiNdebele First Additional Language', 'family': 'isiNdebele'},
        'sal': {'official_code': '11353005', 'alpha': 'NBSAL', 'prefix': 'NDES', 'strand': 'isiNdebele Second Additional Language', 'family': 'isiNdebele'},
    },
    'SEPEDI': {
        'hl': {'official_code': '11351006', 'alpha': 'SEHL', 'prefix': 'SEPH', 'strand': 'Sepedi Home Language', 'family': 'Sepedi'},
        'fal': {'official_code': '11352006', 'alpha': 'SEFAL', 'prefix': 'SEPF', 'strand': 'Sepedi First Additional Language', 'family': 'Sepedi'},
        'sal': {'official_code': '11353006', 'alpha': 'SESAL', 'prefix': 'SEPS', 'strand': 'Sepedi Second Additional Language', 'family': 'Sepedi'},
    },
    'SESOTHO': {
        'hl': {'official_code': '11351007', 'alpha': 'SSHL', 'prefix': 'SESH', 'strand': 'Sesotho Home Language', 'family': 'Sesotho'},
        'fal': {'official_code': '11352007', 'alpha': 'SSFAL', 'prefix': 'SESF', 'strand': 'Sesotho First Additional Language', 'family': 'Sesotho'},
        'sal': {'official_code': '11353007', 'alpha': 'SSSAL', 'prefix': 'SESS', 'strand': 'Sesotho Second Additional Language', 'family': 'Sesotho'},
    },
    'SETSWANA': {
        'hl': {'official_code': '11351008', 'alpha': 'STHL', 'prefix': 'SETH', 'strand': 'Setswana Home Language', 'family': 'Setswana'},
        'fal': {'official_code': '11352008', 'alpha': 'STFAL', 'prefix': 'SETF', 'strand': 'Setswana First Additional Language', 'family': 'Setswana'},
        'sal': {'official_code': '11353008', 'alpha': 'STSAL', 'prefix': 'SETS', 'strand': 'Setswana Second Additional Language', 'family': 'Setswana'},
    },
    'TSHIVENDA': {
        'hl': {'official_code': '11351009', 'alpha': 'TVHL', 'prefix': 'TSHH', 'strand': 'Tshivenda Home Language', 'family': 'Tshivenda'},
        'fal': {'official_code': '11352009', 'alpha': 'TVFAL', 'prefix': 'TSHF', 'strand': 'Tshivenda First Additional Language', 'family': 'Tshivenda'},
        'sal': {'official_code': '11353009', 'alpha': 'TVSAL', 'prefix': 'TSHS', 'strand': 'Tshivenda Second Additional Language', 'family': 'Tshivenda'},
    },
    'XITSONGA': {
        'hl': {'official_code': '11351010', 'alpha': 'XTHL', 'prefix': 'XITH', 'strand': 'Xitsonga Home Language', 'family': 'Xitsonga'},
        'fal': {'official_code': '11352010', 'alpha': 'XTFAL', 'prefix': 'XITF', 'strand': 'Xitsonga First Additional Language', 'family': 'Xitsonga'},
        'sal': {'official_code': '11353010', 'alpha': 'XTSAL', 'prefix': 'XITS', 'strand': 'Xitsonga Second Additional Language', 'family': 'Xitsonga'},
    },
    'SISWATI': {
        'hl': {'official_code': '11351011', 'alpha': 'SWHL', 'prefix': 'SISW', 'strand': 'Siswati Home Language', 'family': 'Siswati'},
        'fal': {'official_code': '11352011', 'alpha': 'SWFAL', 'prefix': 'SISF', 'strand': 'Siswati First Additional Language', 'family': 'Siswati'},
        'sal': {'official_code': '11353011', 'alpha': 'SWSAL', 'prefix': 'SISS', 'strand': 'Siswati Second Additional Language', 'family': 'Siswati'},
    },
    'FRENCH': {
        'sal': {'official_code': '11353012', 'alpha': 'FRSAL', 'prefix': 'FRS', 'strand': 'French Second Additional Language', 'family': 'French'},
    },
    'MANDARIN': {
        'sal': {'official_code': '11353013', 'alpha': 'MNSAL', 'prefix': 'MNS', 'strand': 'Mandarin Second Additional Language', 'family': 'Mandarin'},
    },
}
...
class CAPSLanguageParser:
    ...
    def _parse_topics(self):
        ...
        # Topics 2-5: The four language skills (per grade)
        for grade in [10, 11, 12]:
            for i, (skill_name, skill_name_en, _) in enumerate(skills, 2):
                self.topic_counter += 1
                topic_code = f"{prefix}{i:02d}"
            ...
            for term in [1, 2, 3, 4]:
                for week in range(1, 11):
                    for skill_idx, (skill_name, _, _) in enumerate(skills, 2):
                        topic_code = f"{prefix}{skill_idx:02d}"
                        self.subtopic_counter += 1
                        subtopic_code = f"{prefix}{skill_idx:02d}{self.subtopic_counter:03d}"
...
def main():
    ...
    parser.add_argument('--input-dir', required=True, help='Directory containing CAPS PDFs')
