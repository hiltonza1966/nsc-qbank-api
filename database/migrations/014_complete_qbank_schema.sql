...
BEGIN
  ...
  INSERT IGNORE INTO lookup_subjects (subject_official_code, subject_name, subject_alpha_code, is_active)
  ...
  JOIN nsc_registration_v3.lookup_subjects r ON l.subject_official_code = r.subject_alpha_code
  ...
  -- WHERE subject_official_code NOT IN (SELECT subject_alpha_code FROM nsc_registration_v3.lookup_subjects);
END //
DELIMITER ;
...
INSERT IGNORE INTO parse_expected_structure (year_id, grade_id, subject_id, paper_id, assessment_type_id, assessment_body_id, question_number, question_type_id, section, expected_marks, sequence, parent_question, is_sub_part, cognitive_level_id) VALUES
